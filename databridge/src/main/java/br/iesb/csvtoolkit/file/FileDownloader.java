...
public class FileDownloader extends javax.swing.JDialog {
    ...
    /* Home, que cria e exibe este diálogo */
    public static void main(String args[]) {
	java.awt.EventQueue.invokeLater(() -> {
	    FileDownloader dialog = new FileDownloader(new javax.swing.JFrame(), true);
    ...
    private void initComponents() {
        ...
        consoleWeb.setForeground(new java.awt.Color(0, 102, 204));
