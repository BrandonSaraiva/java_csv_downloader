...
public class AbrirArquivoWeb extends javax.swing.JDialog {
    ...
    private void jButton_DownloadActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DownloadActionPerformed
        ...
        try {
            ...
            jMenuItem_AbrirArquivoBaixado.setEnabled(true); // Ativa o botão após o download bem-sucedido
            ConsoleWeb.setText("Download realizado com sucesso. Local: " + System.getProperty("user.dir") + "\\csvBaixado.csv");
